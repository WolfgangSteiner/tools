...
#define MAX_LEVEL 17
f32 brightness_levels[MAX_LEVEL+1] = { 0.25,  0.5,    1,    1,    1,    1,    1,    2,    4,    6,    8,   10,   25,   50,   60,   70,   80,   90,  100 };
i32 temp_levels[MAX_LEVEL+1] =       { 1500, 1500, 1500, 2000, 2500, 3000, 3500, 3500, 3500, 3500, 3500, 3500, 4000, 4500, 5000, 5000, 5500, 5500, 5500 };
